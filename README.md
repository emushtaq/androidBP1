...
* Flu is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as Flu is mean to act as a starting point for Android Applications.

# Flu App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-eshan-test-flu.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-eshan-test-flu)

This repository contains the source code for the [Flu](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.eshan.test.flu).

Please see the [issues](https://github.com.eshan.test.flu/com-eshan-test-flu/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Flu? Ask away on the [com-eshan-test-flu discussion forum](https://groups.google.com/forum/#!forum/com-eshan-test-flu).

<a href="https://play.google.com/store/apps/details?id=com.eshan.test.flu" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.eshan.test.flu__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.eshan.test.flu__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.eshan.test.flu.R__) will now be renamed
...
signed with a different key.  Manually uninstall Flu from your device and
...
Flu is a result of a template project I've developed over the years as well as
...
Flu is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.eshan.test.flu/com-eshan-test-flu/contributors) on
...
[pull requests](https://github.com.eshan.test.flu/com-eshan-test-flu/pulls).
