...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.eshan.test.flu";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Flu";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.eshan.test.flu.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.eshan.test.flu.";
